...
export const PersonalInfo: React.FC = (): JSX.Element => {
  ...
  type FormProps = {
   ...
   const [values, setValues] =useState<FormProps>({
      ...
      lastName: "",
      birthYear: 1370,
      birthMonth:['فروردین','اردیبهشت','خرداد','تیر','مرداد','شهریور','مهر','آبان','آذر','دی','بهمن','اسفند'],
      gender: false,
      tellNum: "",
      emailAddress: "",
      country: "",
  ...
  return (
    <div className="h-[100vh] bg-bgcolor py-[90px]">
      <form >
        ...
        <File
              ...
              text="افزودن تصویر"
              hasIcon={false}
              styles="text-brand-primary text-xl font-medium border border-brand-primary h-[55px] rounded-lg w-[160px] p-[10px] cursor-pointer border-box text-center bg-[#ffffff]"
            />
        </div>
        <div className="w-2/3 flex flex-wrap flex-row-reverse gap-8">
          <Input
            name={"firstName"}
            className={""}
            type={"text"}
          ...
          <SelectInput options={["خانم","آقا"]} title={"جنسیت"} className="" id="gender" name="gender" />
          <SelectInput options={["متاهل","مجرد"]} title={"وضعیت تاهی"} className="" id="marital" name="marital"  />
          <SelectInput options={["مشمول","معاف","در حال خدمت","پایان خدمت"]} title={"خدمت سربازی"} className="w-1/3" id="military" name="military" />
